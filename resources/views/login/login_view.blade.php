    ...
    <div class="relative min-h-screen sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
        <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
            <div class="self-start hidden lg:flex flex-col  text-gray-300">
                ...
                <p class="pr-3 text-sm opacity-75">Loginn nyukkk</p>
            </div>
        </div>
            ...
            <div class=" p-12 bg-white mx-auto rounded-3xl w-96 ">
                <div class="mb-7">
                    ...
                    @if (Session::get('success'))
                        <p class=" text-green-500 text-center mb-3">{{(Session::get('success'))}}</p>
                    @endif
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative" x-data="{ show: true }">
                        <input placeholder="Password" :type="show ? 'password' : 'text'"
                            class="text-sm  px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-blue-400" name="password">
                    ...
                    <p class="text-gray-400 mt-2">Tidak punya akun? <a href="register"
                    ...
                    <div class="flex justify-center gap-5 w-full ">
                        <a href="auth/google" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-sm text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
